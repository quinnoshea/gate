...
mod tests {
    // Tests for get_bootstrap_token_from_logs removed to avoid unsafe
    // environment variable manipulation. The underlying BootstrapTokenParser
    // functionality is thoroughly tested in gate-core with proper dependency
    // injection patterns.
}
